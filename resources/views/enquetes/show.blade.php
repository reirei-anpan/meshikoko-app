...
<body class="max-w-[770px] mx-auto">
  <div class="bg-custom-bg pb-20">
    ...
    <div class="pl-10">
      ...
      <input type="hidden" id="hs-clipboard-tooltip-on-hover" value="example.js">
      <button type="button" class="js-clipboard mt-10 drop-shadow-lg [--is-toggle-tooltip:false] hs-tooltip relative py-3 px-4 inline-flex justify-between items-center gap-x-2 text-sm font-mono rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none"
        ...
        <span style="max-width: 550px; overflow: hidden; white-space: nowrap; text-overflow: ellipsis;">
          example.js example.js example.js example.js example.js example.js example.js example.js
        </span>
